	...
	<div class="discs">
		<div class="container">
			...
			<div class="row discs_row">
                                    ...
                                    {
                                        $id = $_GET['id'];
                                        $delete = mysqli_query($server, "DELETE FROM `users` WHERE `user_id`='$id'");
                                            if ($delete) {
                                                  echo "<div class='alert alert-block alert-success'>
                                                   <button type='button' class='close' data-dismiss='alert'>×</button>
                                                    User was successfully removed.<br/> </div>";
                                                }else {
...
<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                  ...
                                  $select = mysqli_query($server, "SELECT * FROM `users`") or die('Mysql Error');
                                      while ($column=mysqli_fetch_array($select)) {
                                    echo " <tr>
                                            <td>$column[0]</td>
                                            <td>$column[1]</td>
                                            ...
                                            <td>$column[9]</td>
                                            <td>$column[10]</td>
                                            <td><a class='btn btn-primary' href='allusers.php?id=$column[0]'>Delete<a/></td>";
                                      }
